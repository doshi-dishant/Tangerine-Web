...
public class P2PTransferPage extends SetupInit {
	P2PPageOperations moneyTransferOperations;
	DashBoardPageOperations dashboardPageCommon;
	CommonOperations common;
	elasticwrite log;

	public P2PTransferPage(WebDriver driver, elasticwrite log) {
		this.log = log;
		this.driver = driver;
		moneyTransferOperations = new P2PPageOperations(this.driver, log);
		dashboardPageCommon = new DashBoardPageOperations(driver, log);
		common = new CommonOperations(this.driver, log);
	}

	public Map<Object, Object> P2PTransfer(Map<Object, Object> map) {
